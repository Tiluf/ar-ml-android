...
//    private final Mesh mesh;
    ...
    public RenderEngine() {
        cameraColorTexture = new Texture(Texture.Target.TEXTURE_EXTERNAL_OES, Texture.WrapMode.CLAMP_TO_EDGE,/*useMipmaps=*/ false);
        cameraDepthTexture = new Texture(Texture.Target.TEXTURE_2D, Texture.WrapMode.CLAMP_TO_EDGE,/*useMipmaps=*/ false);
        ...
        mesh = new Mesh(Mesh.PrimitiveMode.TRIANGLE_STRIP, /*indexBuffer=*/ null, vertexBuffers);
    }
    ...
    public void setUseOcclusion(boolean useOcclusion) throws IOException {
        ...
        occlusionShader =
                Shader.createFromAssets("shaders/occlusion.vert", "shaders/occlusion.frag", defines)
                        .setDepthTest(false)
                        .setDepthWrite(false)
