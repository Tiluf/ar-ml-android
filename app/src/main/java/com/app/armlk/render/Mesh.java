...
import com.app.armlk.MainActivity;
...
public class Mesh implements Closeable {
   ...
   * (location 2, vec3).
   */
  public static Mesh createFromAsset( String assetFileName) throws IOException {
    try (InputStream inputStream = MainActivity.assetManager.open(assetFileName)) {
